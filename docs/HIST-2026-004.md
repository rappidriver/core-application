# HIST-2026-004 — Upgrade Java 17 to Java 21 LTS
...
- ✅ Leverage Virtual Threads for better scalability in I/O-intensive operations
- ✅ Improve performance and reduce memory footprint
- ✅ Extend support lifecycle (2029 → 2031)
- ✅ Enable modern language features for cleaner code
- ✅ Maintain backward compatibility (both are LTS versions)
...
### 6. Optional: Enable Virtual Threads (Future Enhancement) 💡
...
- [ ] Application starts successfully: `mvn spring-boot:run` (pending validation)
- [ ] Docker image (if exists) uses Java 21 base image
...
- Hibernate 6.4: Compatible with Java 21 ✅
- MapStruct: Compatible (uses annotation processing) ✅
- Lombok: Version 1.18.30+ required (check pom.xml) ✅
- PostgreSQL JDBC: Compatible ✅
...
*Prepared by AI Assistant — Review, approve, and execute tasks above. Open PR with reference to HIST-2026-004.*
